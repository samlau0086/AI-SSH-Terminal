    ...
    <div className="fixed inset-0 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-white dark:bg-[#18181b] border border-zinc-200 dark:border-zinc-800 rounded-xl w-full max-w-md shadow-2xl overflow-hidden flex flex-col">
        ...
        <div className="flex border-b border-zinc-200 dark:border-zinc-800">
          ...
          <button
            className={`flex-1 py-3 text-xs font-bold tracking-wider uppercase ${activeTab === 'import' ? 'text-emerald-400 border-b-2 border-emerald-500 bg-emerald-500/10' : 'dark:text-zinc-500 text-zinc-500 hover:bg-zinc-800/50'}`}
