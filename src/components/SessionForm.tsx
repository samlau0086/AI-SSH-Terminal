          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="flex gap-2 mb-3">
                <button
                  ...
                  className={`flex-1 py-1.5 text-[11px] font-bold uppercase tracking-wider rounded-md border transition-colors ${formData.authType === 'password' ? 'bg-indigo-500/20 border-indigo-500/50 text-indigo-400' : 'bg-[#09090b] border-zinc-800 text-zinc-500 hover:text-zinc-300'}`}
                >
                ...
                <button
                  ...
                  className={`flex-1 py-1.5 text-[11px] font-bold uppercase tracking-wider rounded-md border transition-colors ${formData.authType === 'privateKey' ? 'bg-indigo-500/20 border-indigo-500/50 text-indigo-400' : 'bg-[#09090b] border-zinc-800 text-zinc-500 hover:text-zinc-300'}`}
                >
              ...
              {formData.authType === 'password' ? (
                ...
                <div className="space-y-2">
                  <textarea 
                    ...
                    className="w-full bg-[#09090b] border border-zinc-800 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-indigo-500 text-zinc-200 font-mono h-24 resize-none"
                  />
                  <input 
                    type="password" 
            ...
            <div>
              ...
              <textarea 
                ...
                className="w-full bg-[#09090b] border border-zinc-800 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-indigo-500 text-zinc-200 h-20 resize-none font-mono"
