...
export default function AuthPage() {
  ...
  return (
    <div className="h-screen w-full flex flex-col items-center justify-center p-4">
      <div className="flex flex-col items-center mb-8 text-zinc-700 dark:text-zinc-300">
      ...
      <div className="bg-white dark:bg-[#18181b] border border-zinc-200 dark:border-zinc-800 rounded-xl w-full max-w-sm overflow-hidden shadow-2xl p-6">
        <h2 className="text-lg font-bold uppercase tracking-widest text-zinc-700 dark:text-zinc-300 mb-6 text-center">
        ...
        <div className="mt-6 text-center">
          <button
            ...
            className="text-xs text-zinc-500 hover:dark:text-zinc-300 transition-colors"
          >
