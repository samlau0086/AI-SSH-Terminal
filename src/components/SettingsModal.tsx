        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-4">
          ...
          <div className="space-y-4">
            ...
            {testStatus !== 'idle' && (
              <div className={`p-3 rounded-lg border text-xs flex items-start gap-2 ${
                testStatus === 'testing' ? 'bg-zinc-800/50 border-zinc-700 text-zinc-300' :
          ...
          <div className="flex justify-between items-center pt-4 mt-4 border-t border-zinc-800">
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-2 text-xs font-bold uppercase tracking-widest border border-zinc-700 hover:bg-zinc-800 text-zinc-300 rounded-lg transition-colors disabled:opacity-50"
            >
